# WasmEdge Runtime - 0.15.0

**Release Name**: WasmEdge 0.15.0
**Published**: 2025-08-04T15:34:55Z
...
Note:
* llama.cpp is using b6399 and supports DeepSeek, Phi-4-mini, TTS, Gemma-3, Gemma-3N, GPT-OSS, and many more advanced features. For the multi-modal models, we also support llava, gemma-3, qwen-2-vl, qwen-2.5-vl, and Mistral Small 3.1.
* If you are using an AMD GPU with ROCm, please use the `WasmEdge-plugin-wasi_nn-ggml-rocm-0.14.1-ubuntu24.04_x86_64.tar.gz` asset. We have only verified that it works on the MI300X.
* Due to the limitation of JetPack 6.2, please download `WasmEdge-plugin-wasi_nn-ggml-cuda-0.15.0-ubuntu22.04_aarch64.tar.gz` if you are using Jetson devices.